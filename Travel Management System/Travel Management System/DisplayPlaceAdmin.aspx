<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="DisplayPlaceAdmin.aspx.cs" Inherits="Travel_Management_System.DisplayPlacesAdmin" %>
    ...
    <asp:ListView ID="ListView1" runat="server"
        ...
        <ItemTemplate>
            <td runat="server" style="">city:
                ...
                <br />
                <a href="EditPlaceAdmin.aspx?place_id=<%#Item.place_id %>">
