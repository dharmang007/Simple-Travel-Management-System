...
<td runat="server" />
        ...
        <ItemTemplate>
            <td runat="server" style="">city:
                ...
                <br />
              <a href="PlaceDetails.aspx?place_id=<%#Item.place_id %>"><asp:Image ID="picImg" runat="server" Height="400px" Width="500px" ImageUrl='<%# Item.pic %>' /></a>
                <br /></td>
        </ItemTemplate>
        <LayoutTemplate>
            <table runat="server">
        ...
        <SelectedItemTemplate>
            <td runat="server" style="">city:
                <asp:Label ID="cityLabel" runat="server" Text='<%# Item.city %>' />
                <br />
               <a href="PlaceDetails.aspx?place_id='<%#Item.place_id %>'"><asp:Image ID="picImg" runat="server" Height="300px" Width="400px" ImageUrl='<%# Item.pic %>' /></a>
                <br /></td>
        </SelectedItemTemplate>
    </asp:ListView>
