...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="form-horizontal col-md-7">      
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <asp:TextBox id="days" runat="server" required="true" TextMode="Number" ForeColor="Black" class="form-control"/>        
            </div>             
        </div>    
        <div class="form-group">
            <div class="control-label col-sm-3">
    ...
    <div class="col-md-5">   
        ...
        <asp:FileUpload ID="FileUpload1" required="true" Style="background-image: url('../Pics/add.png');" runat="server"/>
